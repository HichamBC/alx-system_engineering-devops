1) 0-hello_world file is a script that prints “Hello, World”, followed by a new line to the standard output.
...
25) 101-gifs file is a script that lists all the files with a .gif extension in the current directory and all its sub-directories.
26) 102-acrostic file is a script that decodes acrostics that use the first letter of each line.
